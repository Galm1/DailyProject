...
let givenName;
// A: Nothing. it would come up as 'undefined'
...
// What is `givenName` set to right now?
givenName = givenName;
// A:If we consider the last question, then it is still "Tim"
...
// What is `math` set to?
math = high - "5";
// A:there in not a 'let' or 'var'. So i am assuming it would pop up and error.
